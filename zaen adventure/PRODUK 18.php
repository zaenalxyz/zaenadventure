...
<head>
    ...
    <title>KALAHARI BEANIES - ZAEN Adventure Store</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    ...
    <div class="container">
        <div class="product-image">
            <img src="https://d1yutv2xslo29o.cloudfront.net/product/variant/photo/cacb57fe-1b19-43dc-b686-b4d66b95293a.jpg" alt="Thermo ">
        </div>
        <div class="product-details">
            <h2>KALAHARI BEANIES</h2>
            <p>
            ...
            <div class="price">Rp 132.300</div>
            <form method="POST" action="add_to_cart.php">
                <input type="hidden" name="product_id" value="18"> 
                <input type="hidden" name="product_name" value="KALAHARI BEANIES">
                <input type="hidden" name="product_price" value="132300">
                <input type="hidden" name="product_image" value="https://d1yutv2xslo29o.cloudfront.net/product/variant/photo/cacb57fe-1b19-43dc-b686-b4d66b95293a.jpg">
